...
public class Adapter_Class_Plan extends RecyclerView.Adapter<Adapter_Class_Plan.ViewHolder> {
    ...
    public Adapter_Class_Plan(Context context, ArrayList<String> mSubject, ArrayList<String> mText, ArrayList<String> mTime, ArrayList<String> mKey, ArrayList<String> mTeacherKey) {
    ...
    @NonNull
    @Override
    public Adapter_Class_Plan.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.classplan,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Class_Plan.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,Update_Class_PlanActivity.class);
