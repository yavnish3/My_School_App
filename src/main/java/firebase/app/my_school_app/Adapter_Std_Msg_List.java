...
public class Adapter_Std_Msg_List extends RecyclerView.Adapter<Adapter_Std_Msg_List.ViewHolder> {
    ...
    public Adapter_Std_Msg_List(Context context, ArrayList<String> mName, ArrayList<String> mFname, ArrayList<String> mMname, ArrayList<String> mClass, ArrayList<String> mKey, ArrayList<String> mDp) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,Send_St_Msg.class);
