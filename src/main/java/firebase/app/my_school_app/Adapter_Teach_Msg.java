...
public class Adapter_Teach_Msg extends RecyclerView.Adapter<Adapter_Teach_Msg.ViewHolder> {
    ...
    public Adapter_Teach_Msg(Context context, ArrayList<String> mSubject, ArrayList<String> mText, ArrayList<String> mTime, ArrayList<String> mKey, ArrayList<String> mTeacherKey) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,Update_Teach_Msg.class);
