...
public class Adapter_Teacher_List extends RecyclerView.Adapter<Adapter_Teacher_List.ViewHolder> {
    ...
    public Adapter_Teacher_List(Context context, ArrayList<String> mName, ArrayList<String> mDp, ArrayList<String> mFname, ArrayList<String> mKey, ArrayList<String> mmobile) {
    ...
    @NonNull
    @Override
    public Adapter_Teacher_List.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lists,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Teacher_List.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,Teacher_Profile_DetailsActivity.class);
