...
public class Adapter_Teacher_Result extends RecyclerView.Adapter<Adapter_Teacher_Result.ViewHolder> {
    ...
    public Adapter_Teacher_Result(Context context, ArrayList<String> mName, ArrayList<String> mFname, ArrayList<String> mMname, ArrayList<String> mClass, ArrayList<String> mKey, ArrayList<String> mDp) {
    ...
    @NonNull
    @Override
    public Adapter_Teacher_Result.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lists,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_Teacher_Result.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,Send_Result.class);
