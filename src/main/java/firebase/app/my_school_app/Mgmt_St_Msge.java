...
public class Mgmt_St_Msge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mgmt__st__msge);
    ...
    public void showStlist(View view) {
        ...
        databaseReference.child("2019").child("student").child(cls).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot mykey:dataSnapshot.getChildren())
                {
                    ...
                    Adapter_Std_Msg_List adapter=new Adapter_Std_Msg_List(Mgmt_St_Msge.this,mName,mFname,mMname,mclass,mKey,mDp);
