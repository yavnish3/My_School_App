...
public class Send_Result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send__result);
        ...
        databaseReference.child("2019").child("student").child(cls).child(key).child("result").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot mykey : dataSnapshot.getChildren()) {
                    ...
                    Adapter_Send_Result adapter = new Adapter_Send_Result(Send_Result.this,mSubject,mText,mMrkOb,mTlMrk,mTime,mKey,mTeacherKey,clas);
    ...
    public void addresult(View view) {
        Intent intent=new Intent(Send_Result.this,Add_Teacher_Result.class);
