...
public class Student_Message_Adapter extends RecyclerView.Adapter<Student_Message_Adapter.ViewHolder> {
    ...
    public Student_Message_Adapter(Context context, ArrayList<String> mSubject, ArrayList<String> mText, ArrayList<String> mTime, ArrayList<String> mKey, ArrayList<String> mTeacherKey, String cls) {
    ...
    @NonNull
    @Override
    public Student_Message_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.classplan,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Student_Message_Adapter.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,Student_Full_Message.class);
