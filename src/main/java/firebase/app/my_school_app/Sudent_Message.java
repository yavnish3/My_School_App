...
public class Sudent_Message extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sudent__message);
        ...
        databaseReference.child("2019").child("student").child(cls).child(key).child("message").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot mykey : dataSnapshot.getChildren()) {
                    ...
                    Student_Message_Adapter adapter = new Student_Message_Adapter(Sudent_Message.this,mSubject,mText,mTime,mKey,mTeacherKey,cls);
