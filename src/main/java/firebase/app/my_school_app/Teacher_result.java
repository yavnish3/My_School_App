...
public class Teacher_result extends AppCompatActivity {
        ...
        databaseReference.child("2019").child("student").child(cls).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot mykey:dataSnapshot.getChildren())
                {
                    ...
                    Adapter_Teacher_Result adapter=new Adapter_Teacher_Result(Teacher_result.this,mName,mFname,mMname,mclass,mKey,mDp);
